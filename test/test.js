...
const diffArrayLen = require("../01-diff-array-lens.js");
const avgValue = require("../02-avg-value.js");
const tripler = require("../03-tripler.js");
const oddRange = require("../04-odd-range.js");
const evenRange = require("../05-even-range.js");
const reverseString = require("../06-reverse-string.js");
const intersect = require("../07-intersect-arrays.js");
const fuzzBizz = require("../08-fuzz-bizz.js");
const mirrorArray = require("../09-mirror-array.js");
